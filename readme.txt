...
Contributors: errnio
Tags: Tap, Tappy, text selection, right click, curio, gesture, analytics, bounce rate, click to tweet, content, content analytics, content recommendation, engagement, errnio, exit-intent, increase traffic, mobile, mobile web, plugin, scroll box, time spent, widget, wordpress, wikipedia, definition, dictionary, Ads for website, Ads for websites, Ads on website, In Text Advertising, make money, monetize, Monetize Website, PPC ads, text ads
...
**Tap to Define** by **errnio** adds a new engagement layer to your mobile site. With every tap and text selection of a word or piece of text, the user is immediately presented with a definition at the top of the screen. The highlighted text is defined from a variety of relevant sources and presented with an overlay at the top of the screen. Tap to Define also adds several buttons to share or search.

This tool enhances user experience, engaging your visitors with your content on mobile. errnio can increase your pages per visit, time spent on site, and improve your over site engagement on mobile. By keeping the user engaged in your site, errnio will help you retain your incoming visits.
...
**Tap to Define** main features include the following items and actions:

* **Word or Phrase Definition** - Tap to Define definitions are displayed above the selected text. Upon selection of the text, Tap to Define offers a relevant definition of the item from a variety of open sources throughout the internet.
...
1. Tap to Define text selection experience, with definition at the top.
